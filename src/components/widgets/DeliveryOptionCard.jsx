...
export default function DeliveryOptionCard({ option }) {
    ...
    return (
        <div className={`flex flex-row items-center gap-3
            border border-primary rounded-lg font-normal text-left h-auto py-2 px-4 cursor-pointer
            ${delivery === option ? 'text-secondary bg-primary' : 'text-primary'}`} onClick={() => onClickDeliveryOption(option)}>
